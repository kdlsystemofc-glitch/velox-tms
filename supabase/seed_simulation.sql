...
-- ============================================================
-- ░░ VERIFICAÇÕES — rode tudo abaixo e leia a coluna "problemas".
-- ░░ problemas = 0  → consistente.   problemas > 0  → investigar.
-- ░░ Rode DE NOVO depois de operar pelo app (dar baixa, confirmar,
-- ░░ cancelar, fechar fatura) para flagrar quebras de fluxo/lógica.
-- ============================================================

-- 1) INTEGRIDADE REFERENCIAL E FLUXO
...
-- 2) RESUMO FINANCEIRO (compare com o que o app mostra no Financeiro/DRE)
SELECT
...
-- 3) CONFERÊNCIA: receitas ativas devem casar com os fretes dos pedidos não cancelados (confirmados+)
SELECT
...
-- (os dois valores acima devem ser IGUAIS)
