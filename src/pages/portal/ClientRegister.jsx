    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-muted/40 p-4">
        <div className="max-w-md w-full bg-card rounded-2xl border border-border p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">Sua solicitação de acesso foi enviada. Assim que a Velox aprovar e vincular sua empresa, você poderá entrar no Portal do Cliente.</p>
      ...
      <div className="max-w-md w-full bg-card rounded-2xl border border-border p-8">
        <div className="flex items-center gap-2.5 mb-5">
          ...
          <div className="leading-none">
            ...
            <span className="text-[10px] text-muted-foreground uppercase tracking-widest">Portal do Cliente</span>
          </div>
        </div>
        <h1 className="font-display text-xl font-bold text-foreground">Criar acesso de cliente</h1>
        <p className="text-sm text-muted-foreground mb-5">Cadastre-se para acompanhar seus pedidos. A Velox aprova e vincula sua empresa.</p>
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div>
            <label className="text-xs font-medium text-muted-foreground">Empresa (Razão social ou CNPJ) *</label>
            <input className="mt-1 w-full rounded-lg border border-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
