    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="max-w-md w-full bg-white rounded-2xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-sm text-gray-600">Sua solicitação foi enviada. Assim que a Velox aprovar e vincular sua transportadora, você poderá entrar no Portal da Transportadora e receber ofertas de frete.</p>
      ...
      <div className="max-w-md w-full bg-white rounded-2xl border border-gray-200 p-8">
        <div className="flex items-center gap-2.5 mb-5">
          ...
          <div className="leading-none">
            ...
            <span className="text-[10px] text-gray-500 uppercase tracking-widest">Portal da Transportadora</span>
          </div>
        </div>
        <h1 className="font-display text-xl font-bold text-gray-900">Criar acesso de parceiro</h1>
        <p className="text-sm text-gray-500 mb-5">Cadastre sua transportadora para receber ofertas de frete da Velox. A Velox aprova e vincula.</p>
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div>
            <label className="text-xs font-medium text-gray-600">Transportadora (Razão social ou CNPJ) *</label>
            <input className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
