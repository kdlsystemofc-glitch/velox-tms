            ...
            <CardContent className="pt-4">
              {editing ? (
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Button className="col-span-2 font-bold" onClick={() => {
                      const payload = {
      ...
      <Dialog open={showMaintModal} onOpenChange={(v) => { if (!v) { setShowMaintModal(false); setMaintForm(EMPTY_MAINT); } }}>
        <DialogContent className="max-w-lg">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button className="flex-1 font-bold" onClick={addMaintenance} disabled={!maintForm.date || !maintForm.description || updateMutation.isPending}>
