...
import { BarChart3, TrendingUp, TrendingDown, FileText, Activity, DollarSign, Receipt, Landmark, ScanLine, BookOpen } from "lucide-react";
...
import SettlementLedger from "@/pages/admin/SettlementLedger";
    ...
    <div className="space-y-4">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        <TabsList className={segmentedTabsClass}>
          ...
          <TabsTrigger value="razao" className={segmentedTriggerClass}><BookOpen className="w-3.5 h-3.5" /> Razão</TabsTrigger>
        ...
        <TabsContent value="razao" className="mt-4"><SettlementLedger /></TabsContent>
